...
`user_profile`) VALUES
    (1, '" .$user_name."', '".$user_password_hash."', '".$user_email."', '".$user_pid."', 5, '".$userPerms."', '".$user_pic."');") or die('2: '.mysqli_error($link));
            ...
            mysqli_query($link, "INSERT INTO `users` (`user_id`, `user_name`, `user_password_hash`, `user_email`, `user_level`, `permissions`, `user_profile`) VALUES
    ...
    ('" .$server_name."', '1', '".$server_type."', '".$server_use_SQ."', '".$server_PORT."', '".$server_IP."', '".$server_RCON."');") or die('8: '.mysqli_error($link));
        } else {
    ...
    <header class="header black-bg">
        ...
        echo 'value="'.$_POST['community_name'].'"';
                            ...
                            <input placeholder="Username" id="user_name"
                                   class="form-control login_input" type="text" name="user_name" <?php if (isset($_POST['user_name'])) {
        echo 'value="'.$_POST['user_name'].'"';
    } ?>>

                            <label for="user_email">Email: </label>
                            <input placeholder="Email" id="user_email" class="form-control login_input"
                                   type="email" name="user_email" required <?php if (isset($_POST['user_email'])) {
        echo 'value="'.$_POST['user_email'].'"';
                            ...
                            <input placeholder="Password" id="user_password"
                                   ...
                                   autocomplete="off" required <?php if (isset($_POST['user_password'])) {
        echo 'value="'.$_POST['user_password'].'"';
    } ?>>

                            <label for="user_pid">Player ID: </label>
                            <input placeholder="Player ID" id="user_pid"
                                   class="form-control login_input" type="number" name="user_pid" <?php if (isset($_POST['user_pid'])) {
        echo 'value="'.$_POST['user_pid'].'"';
    } ?>>
                            ...
                            <input placeholder="SQL Host" id="server_SQL_host"
                                ...
                                <?php if (isset($_POST['server_SQL_host'])) {
                                echo 'value="'.$_POST['server_SQL_host'].'"';
                            } ?>>
                            ...
                            <input placeholder="SQL User" id="server_SQL_user"
                                ...
                                <?php if (isset($_POST['server_SQL_user'])) {
                                echo 'value="'.$_POST['server_SQL_user'].'"';
                            } ?>>
                            ...
                            <input placeholder="SQL Password" id="server_SQL_pass"
                                ...
                                <?php if (isset($_POST['server_SQL_pass'])) {
                                echo 'value="'.$_POST['server_SQL_pass'].'"';
                            } ?>>
                            ...
                            <input placeholder="SQL Database Name" id="server_SQL_name"
                                ...
                                <?php if (isset($_POST['server_SQL_name'])) {
                                echo 'value="'.$_POST['server_SQL_name'].'"';
                            } ?>>
                            <br><br>
                            ...
                            <input placeholder="Server Query Port (Default: 2302)" id="server_port"
                                ...
                                <?php if (isset($_POST['server_port'])) {
                                echo 'value="'.$_POST['server_port'].'"';
                            } ?>>
                            ...
                            <input placeholder="Server Query IP" id="server_IP"
                                ...
                                <?php if (isset($_POST['server_IP'])) {
                                echo 'value="'.$_POST['server_IP'].'"';
                            } ?>>
