        ...
        <div class="content-panel">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tr>
                    ...
                    <?php if ($_SESSION['permissions']['edit']['staff']) echo '<th><i class="fa fa-pencil"></i> ' . $lang['edit'] . '</th>'; ?>
                </tr>
                </thead>
                <tbody>
                <?php
