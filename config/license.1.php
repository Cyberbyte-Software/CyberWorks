...
if ($licenseLang == 'en') {
    ...
    // Custom
    $license['Bounty'] = 'Bounty License';
    $license['whitelisted'] = 'Whitelisted';
    $license['donator'] = 'Donator License';
    $license['medmarijuana'] = 'Medical Marijuana';
    $license['med420'] = 'Medical Card Marijuana';
    $license['logging'] = 'Logging License';
    $license['metal'] = 'Metal License';
    $license['taxi'] = 'Taxi License';
    $license['meth'] = 'Meth License';
...
function licName($lic,$license)
{
    ...
    // CUSTOM
    elseif ($lic == 'license_civ_Bounty') return $license['Bounty'];
    elseif ($lic == 'license_civ_whitelisted') return $license['whitelisted'];
    elseif ($lic == 'license_civ_donator') return $license['donator'];
    elseif ($lic == 'license_civ_medmarijuana') return $license['medmarijuana'];
    elseif ($lic == 'license_civ_med420') return $license['med420'];
    elseif ($lic == 'license_civ_logging') return $license['logging'];
    elseif ($lic == 'license_civ_metal') return $license['metal'];
    elseif ($lic == 'license_civ_taxi') return $license['taxi'];
    elseif ($lic == 'license_civ_meth') return $license['meth'];
